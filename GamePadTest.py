...
while True:
  ...
  if (not L2) and (not GPIO.input(24)):  # Left button pressed
    L2 = True
    #print("select pressed")
    device.emit(uinput.KEY_M, 1) # Press Left key
  if L2 and GPIO.input(24):  # Left button released
    L2 = False
  ...
  if (not R2) and (not GPIO.input(1)):  # Left button pressed
    R2 = True
    #print("select pressed")
    device.emit(uinput.KEY_N, 1) # Press Left key
  if R2 and GPIO.input(1):  # Left button released
    R2 = False
